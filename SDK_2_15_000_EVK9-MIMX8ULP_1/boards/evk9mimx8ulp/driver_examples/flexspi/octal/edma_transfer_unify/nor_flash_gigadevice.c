...
/* For GD25LX256 */
const uint32_t ReadLUTCmdSeq_GIGADEVICE[4] = {
...
const uint32_t OctalReadLUTCmdSeq_GIGADEVICE[4] = {
    /*  OPI DDR read */
    [4 * NOR_CMD_LUT_SEQ_IDX_READ + 0] = FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR,
                                                         kFLEXSPI_8PAD,
                                                         SPINOR_OP_READ_FAST,
...
const uint32_t LUTOctalMode_GIGADEVICE[CUSTOM_LUT_LENGTH] = {
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_ERASESECTOR_DTR_OPI] = FLEXSPI_LUT_SEQ(
