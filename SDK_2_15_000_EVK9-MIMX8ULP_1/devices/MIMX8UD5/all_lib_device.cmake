...
include_if_use(DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
include_if_use(RTE_Device.MIMX8UD5)
include_if_use(component_audio_sai_edma_adapter.MIMX8UD5)
include_if_use(component_button.MIMX8UD5)
include_if_use(component_codec_adapters.MIMX8UD5)
include_if_use(component_codec_i2c.MIMX8UD5)
include_if_use(component_common_task)
include_if_use(component_da7212_adapter.MIMX8UD5)
include_if_use(component_i3c_adapter.MIMX8UD5)
include_if_use(component_i3c_bus.MIMX8UD5)
include_if_use(component_i3c_bus_adapter.MIMX8UD5)
include_if_use(component_lists.MIMX8UD5)
include_if_use(component_lpi2c_adapter.MIMX8UD5)
include_if_use(component_lpit_adapter.MIMX8UD5)
include_if_use(component_lpspi_adapter.MIMX8UD5)
include_if_use(component_lptmr_adapter.MIMX8UD5)
include_if_use(component_lpuart_adapter.MIMX8UD5)
include_if_use(component_lpuart_dma_adapter.MIMX8UD5)
include_if_use(component_mem_manager.MIMX8UD5)
include_if_use(component_mem_manager_light.MIMX8UD5)
include_if_use(component_mrt_adapter.MIMX8UD5)
...
include_if_use(component_panic.MIMX8UD5)
include_if_use(component_pwm_tpm_adapter.MIMX8UD5)
include_if_use(component_reset_adapter.MIMX8UD5)
include_if_use(component_rgpio_adapter.MIMX8UD5)
include_if_use(component_rtc_bbnsm_adapter.MIMX8UD5)
include_if_use(component_serial_manager.MIMX8UD5)
include_if_use(component_serial_manager_spi.MIMX8UD5)
include_if_use(component_serial_manager_swo.MIMX8UD5)
include_if_use(component_serial_manager_uart.MIMX8UD5)
include_if_use(component_serial_manager_virtual.MIMX8UD5)
include_if_use(component_sgtl_adapter.MIMX8UD5)
include_if_use(component_software_crc_adapter.MIMX8UD5)
include_if_use(component_software_rng_adapter.MIMX8UD5)
include_if_use(component_timer_manager.MIMX8UD5)
include_if_use(component_tpm_adapter.MIMX8UD5)
include_if_use(component_wm8960_adapter.MIMX8UD5)
include_if_use(device_MIMX8UD5_CMSIS.MIMX8UD5)
include_if_use(device_MIMX8UD5_DSP.MIMX8UD5)
include_if_use(device_MIMX8UD5_startup.MIMX8UD5)
include_if_use(driver_acmp.MIMX8UD5)
include_if_use(driver_bbnsm.MIMX8UD5)
include_if_use(driver_cache_cache64.MIMX8UD5)
include_if_use(driver_casper.MIMX8UD5)
include_if_use(driver_clock.MIMX8UD5)
include_if_use(driver_cmsis_lpi2c.MIMX8UD5)
include_if_use(driver_cmsis_lpspi.MIMX8UD5)
include_if_use(driver_cmsis_lpuart.MIMX8UD5)
include_if_use(driver_codec.MIMX8UD5)
include_if_use(driver_common.MIMX8UD5)
include_if_use(driver_dac12.MIMX8UD5)
include_if_use(driver_dc-fb-common.MIMX8UD5)
include_if_use(driver_dc-fb-lcdif.MIMX8UD5)
include_if_use(driver_dialog7212.MIMX8UD5)
include_if_use(driver_display-common.MIMX8UD5)
include_if_use(driver_display-hx8394.MIMX8UD5)
include_if_use(driver_display-it6161.MIMX8UD5)
include_if_use(driver_display-mipi-dsi-cmd.MIMX8UD5)
include_if_use(driver_display-rm68200.MIMX8UD5)
include_if_use(driver_dma3.MIMX8UD5)
include_if_use(driver_ewm.MIMX8UD5)
include_if_use(driver_flexcan.MIMX8UD5)
include_if_use(driver_flexcan_edma.MIMX8UD5)
include_if_use(driver_flexio.MIMX8UD5)
include_if_use(driver_flexio_camera.MIMX8UD5)
include_if_use(driver_flexio_camera_edma.MIMX8UD5)
include_if_use(driver_flexio_i2c_master.MIMX8UD5)
include_if_use(driver_flexio_i2s.MIMX8UD5)
include_if_use(driver_flexio_i2s_edma.MIMX8UD5)
include_if_use(driver_flexio_mculcd.MIMX8UD5)
include_if_use(driver_flexio_mculcd_edma.MIMX8UD5)
include_if_use(driver_flexio_spi.MIMX8UD5)
include_if_use(driver_flexio_spi_edma.MIMX8UD5)
include_if_use(driver_flexio_uart.MIMX8UD5)
include_if_use(driver_flexio_uart_edma.MIMX8UD5)
include_if_use(driver_flexspi.MIMX8UD5)
include_if_use(driver_flexspi_dma3.MIMX8UD5)
include_if_use(driver_fusion.MIMX8UD5)
include_if_use(driver_fxos8700cq.MIMX8UD5)
include_if_use(driver_i3c.MIMX8UD5)
include_if_use(driver_iomuxc.MIMX8UD5)
include_if_use(driver_lcdif.MIMX8UD5)
include_if_use(driver_lpadc.MIMX8UD5)
include_if_use(driver_lpi2c.MIMX8UD5)
include_if_use(driver_lpi2c_edma.MIMX8UD5)
include_if_use(driver_lpi2c_freertos.MIMX8UD5)
include_if_use(driver_lpit.MIMX8UD5)
include_if_use(driver_lpspi.MIMX8UD5)
include_if_use(driver_lpspi_edma.MIMX8UD5)
include_if_use(driver_lpspi_freertos.MIMX8UD5)
include_if_use(driver_lptmr.MIMX8UD5)
include_if_use(driver_lpuart.MIMX8UD5)
include_if_use(driver_lpuart_edma.MIMX8UD5)
include_if_use(driver_lpuart_freertos.MIMX8UD5)
include_if_use(driver_memory.MIMX8UD5)
include_if_use(driver_mipi_dsi.MIMX8UD5)
include_if_use(driver_mrt.MIMX8UD5)
include_if_use(driver_mu1.MIMX8UD5)
include_if_use(driver_nand_flash-common.MIMX8UD5)
include_if_use(driver_nand_flash-controller-flexspi.MIMX8UD5)
include_if_use(driver_nor_flash-common.MIMX8UD5)
include_if_use(driver_nor_flash-controller-flexspi.MIMX8UD5)
include_if_use(driver_nor_flash-controller-lpspi.MIMX8UD5)
include_if_use(driver_pca6416a.MIMX8UD5)
include_if_use(driver_pdm.MIMX8UD5)
include_if_use(driver_pdm_edma.MIMX8UD5)
include_if_use(driver_pf1550.MIMX8UD5)
include_if_use(driver_powerquad.MIMX8UD5)
include_if_use(driver_powerquad_cmsis.MIMX8UD5)
include_if_use(driver_pxp.MIMX8UD5)
include_if_use(driver_reset.MIMX8UD5)
include_if_use(driver_rgpio.MIMX8UD5)
include_if_use(driver_rtd_cmc.MIMX8UD5)
include_if_use(driver_sai.MIMX8UD5)
include_if_use(driver_sai_edma.MIMX8UD5)
include_if_use(driver_sema42.MIMX8UD5)
include_if_use(driver_sentinel.MIMX8UD5)
include_if_use(driver_sgtl5000.MIMX8UD5)
include_if_use(driver_soc_mipi_dsi.MIMX8UD5)
include_if_use(driver_srtm.MIMX8UD5)
include_if_use(driver_srtm_freertos.MIMX8UD5)
include_if_use(driver_tpm.MIMX8UD5)
include_if_use(driver_trdc.MIMX8UD5)
include_if_use(driver_trgmux.MIMX8UD5)
include_if_use(driver_tstmr.MIMX8UD5)
include_if_use(driver_upower.MIMX8UD5)
include_if_use(driver_video-common.MIMX8UD5)
include_if_use(driver_video-i2c.MIMX8UD5)
include_if_use(driver_wdog32.MIMX8UD5)
include_if_use(driver_wm8960.MIMX8UD5)
include_if_use(driver_wuu.MIMX8UD5)
include_if_use(middleware_baremetal.MIMX8UD5)
...
include_if_use(utilities_misc_utilities.MIMX8UD5)
include_if_use(utility_assert.MIMX8UD5)
include_if_use(utility_assert_lite.MIMX8UD5)
include_if_use(utility_debug_console.MIMX8UD5)
include_if_use(utility_debug_console_lite.MIMX8UD5)
include_if_use(utility_notifier.MIMX8UD5)
include_if_use(utility_shell.MIMX8UD5)
include_if_use(utility_str.MIMX8UD5)
